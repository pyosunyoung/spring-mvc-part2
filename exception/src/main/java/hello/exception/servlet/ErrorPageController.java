...
public class ErrorPageController {
    ...
    @RequestMapping("/error-page/404")// post, get이런것들 한번에 에러 처리하기 위해 requestMapping 사용
    ...
    } //Accept 타입이 applicationjson json일 떄 호출됨. 해당 컨트롤러가 기존 errorPage500 보다 더 우선권을 가짐
    //만약 json이 아니면 위에 html error 폼이 값으로 반환됨.
